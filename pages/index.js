    ...
    <TimerControlProvider>
      <div className="min-h-screen flex flex-col md:flex-row">
        ...
        <main className={`flex-1 p-6 transition-all duration-300 ${isInfoOpen ? "md:mr-[15rem]" : ""}`}>
          ...
          <p className="mt-2 text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
        ...
        <div className={`fixed right-0 top-0 h-full bg-gray-200 w-60 md:w-1/6 p-4 transition-transform duration-300 ${isInfoOpen ? "translate-x-0 w-full h-full" : "translate-x-full"}`}>
